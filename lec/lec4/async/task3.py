...
'''Функция process_file() открывает файл для чтения и считывает его содержимое с помощью метода read(). 
Затем происходит обработка содержимого файла (которая может быть любой, в зависимости от требований конкретной задачи). 
