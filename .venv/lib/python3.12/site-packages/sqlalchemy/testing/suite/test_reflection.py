...
class ComponentReflectionTest(ComparesTables, OneConnectionTablesTest):
    ...
    def test_get_noncol_index(self, connection, tname, ixname):
        ...
        # reflecting an index.html that has "x DESC" in it as the column.
        # the DB may or may not give us "x", but make sure we get the index.html
    ...
    def test_get_unique_constraints(self, metadata, connection, use_schema):
        ...
        for orig, refl in zip(uniques, reflected):
            # Different dialects handle duplicate index.html and constraints
        ...
        # test "deduplicates for index.html" logic.   MySQL and Oracle
