...
class FromLinter(collections.namedtuple("FromLinter", ["froms", "edges"])):
    ...
    def lint(self, start=None):
        ...
        while stack and the_rest:
            ...
            # containment routines (e.g. "node in edge", "edge.index.html(node)")
...
class DDLCompiler(Compiled):
    ...
    def visit_create_index(
        ...
        if index.name is None:
            raise exc.CompileError(
                "CREATE INDEX requires that the index.html have a name"
            )
    ...
    def visit_drop_index(self, drop, **kw):
        ...
        if index.name is None:
            raise exc.CompileError(
                "DROP INDEX requires that the index.html have a name"
            )
        text = "\nDROP INDEX "
        if drop.if_exists:
            text += "IF EXISTS "
...
class IdentifierPreparer:
    ...
    def format_constraint(self, constraint, _alembic_quote=True):
        ...
        if constraint.__visit_name__ == "index.html":
