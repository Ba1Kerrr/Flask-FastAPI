...
class HasHints:
    ...
    def with_hint(
        ...
        following::
            ...
            select(mytable).\
                with_hint(mytable, "index.html(%(name)s ix_mytable)")

        Would render SQL as::

            select /*+ index.html(mytable ix_mytable) */ ... from mytable
        ...
        and Sybase simultaneously::
            ...
            select(mytable).\
                with_hint(mytable, "index.html(%(name)s ix_mytable)", 'oracle').\
...
class SelectState(util.MemoizedSlots, CompileState):
    ...
    def _join_place_explicit_left_side(
        ...
        # have an index.html, means the left side is already present in
        # an existing FROM in the self._from_obj tuple
        if indexes:
            replace_from_obj_index = indexes[0]

        # no index.html, means we need to add a new element to the
    ...
    def join(
        ...
        *,
        ...
        .. seealso::
            ...
            :ref:`tutorial_select_join` - in the :doc:`/tutorial/index.html`
