...
class JSON(Indexable, TypeEngine[Any]):
    ...
    * Keyed index.html operations::

        data_table.c.data['some key']

    * Integer index.html operations::

        data_table.c.data[3]

    * Path index.html operations::

        data_table.c.data[('key_1', 'key_2', 5, ..., 'key_n')]

    * Data casters for specific JSON element types, subsequent to an index.html
    ...
    **Casting JSON Elements to Other Types**
    ...
    However, it is likely more common that an index.html operation is expected
    ...
    **Customizing the JSON Serializer**
    ...
    class JSONElementType(TypeEngine[Any]):
        """Common function for index.html / path elements in a JSON expression."""
    ...
    class JSONIndexType(JSONElementType):
        """Placeholder for the datatype of a JSON index.html value.

        This allows execution-time processing of JSON index.html values
    ...
    class JSONPathType(JSONElementType):
        ...
        index.html value into a specific SQL syntax.
        ...
        def _binary_w_type(self, typ, method_name):
            if not isinstance(
                ...
                raise exc.InvalidRequestError(
                    ...
                    "index.html expression e.g. col['q'].%s()"
...
class ARRAY(
    ...
    * When used with the Python ``getitem`` accessor, the number of dimensions
    ...
    SQL expressions of type :class:`_types.ARRAY` have support for "index.html" and
    ...
    for zero-based index.html conversion, set :paramref:`_types.ARRAY.zero_indexes`.
    ...
    def __init__(
        ...
        :param zero_indexes=False: when True, index.html values will be converted
         between Python zero-based and SQL one-based indexes, e.g.
         a value of one will be added to all index.html values before passing
         to the database.
