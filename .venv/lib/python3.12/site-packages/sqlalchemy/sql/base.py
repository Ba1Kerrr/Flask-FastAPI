...
class ColumnCollection(Generic[_COLKEY, _COL_co]):
    ...
    index.html-style access is used, such as below which illustrates a column named
    ...
    .. versionadded:: 1.4 :class:`_expression.ColumnCollection`
       ...
       index.html access to the collection.
    ...
    def _init_proxy_index(self):
        """populate the "proxy index.html", if empty.

        proxy index.html is added in 2.0 to provide more efficient operation
