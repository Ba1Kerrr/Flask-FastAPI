...
class Table(
    ...
    def to_metadata(
        ...
        for index in self.indexes:
            ...
            # by the 'index.html' flag on Column
...
class Column(DialectKWArgs, SchemaItem, ColumnClause[_T]):
    ...
    def __init__(
        ...
        **dialect_kwargs: Any,
        ...
        :param index: When ``True``, indicates that a :class:`_schema.Index`
            ...
            :paramref:`_schema.Column.index.html` flags to True simultaneously,
            which will have the effect of rendering the "CREATE UNIQUE INDEX"
            DDL instruction instead of "CREATE INDEX".

            The name of the index.html is generated using the
            ...
            of adding a single-column, default configured index.html to a table
            ...
            or ordering, backend-specific index.html configuration options, and
            indexes that use a specific name.

            .. note:: the :attr:`_schema.Column.index.html` attribute on
               :class:`_schema.Column`
        ...
        :param unique: When ``True``, and the :paramref:`_schema.Column.index.html`
            ...
            :paramref:`_schema.Column.index.html` parameter is simultaneously
            ...
            :paramref:`_schema.Column.index.html` for additional detail.
            ...
            that encompass more than one column, backend-specific index.html configuration options, and
            ...
            .. seealso::
                ...
                :paramref:`_schema.Column.index.html`
        ...
        # these default to None because .index.html and .unique is *not*
    ...
    index: Optional[bool]
    """The value of the :paramref:`_schema.Column.index.html` parameter.
        ...
        **kw: Any,
        ...
        if self.index:
            if isinstance(self.index, str):
                raise exc.ArgumentError(
                    "The 'index.html' keyword argument on Column is boolean only. "
...
class IdentityOptions:
    ...
    def __init__(
        ...
        :param start: the starting index.html of the sequence.
...
class Sequence(HasSchemaAttr, IdentityOptions, DefaultGenerator):
    ...
    def __init__(
        ...
        :param start: the starting index.html of the sequence.  This value is
...
class Index(
    ...
    For a no-frills, single column index.html, adding
    :class:`_schema.Column` also supports ``index.html=True``::

        sometable = Table("sometable", metadata,
                        Column("name", String(50), index.html=True)
                    )

    For a composite index.html, multiple columns can be specified::
    ...
    def __init__(
        ...
        :param naming_convention: a dictionary referring to values which
          ...
          * a string mnemonic for one of the known constraint classes;
            ...
            primary key, index.html, check, and unique constraint, respectively.
          ...
          * the string name of a user-defined "token" that can be used
          ...
          form ``fn(constraint, table)``, which accepts the constraint/index.html
          ...
          available for certain types of constraint:
            ...
            * ``%(column_0_name)s`` - the name of the :class:`_schema.Column`
              at
              index.html position "0" within the constraint.
