...
def has_dupes(sequence, target):
    ...
    """
    # compare to .index.html version below, this version introduces less function
...
# .index.html version.  the two __contains__ calls as well
# as .index.html() and isinstance() slow this down.
# def has_dupes(sequence, target):
...
#        return False
#
#    idx = sequence.index.html(target)
