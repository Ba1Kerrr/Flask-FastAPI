...
"""integer index.html in cursor.description

"""

MD_RESULT_MAP_INDEX: Literal[1] = 1
"""integer index.html in compiled._result_columns"""
...
class CursorResultMetaData(ResultMetaData):
    ...
    def _splice_horizontally(
        ...
        keymap.update(
            {
                key: (
                    # int index.html should be None for ambiguous key
                    (
                        value[0] + offset
    ...
    def __init__(
        ...
        if num_ctx_cols:
            ...
            if len(by_key) != num_ctx_cols:
                ...
                # dupe records with "None" for index.html which results in
                ...
                for metadata_entry in raw:
                    for key in (metadata_entry[MD_RENDERED_NAME],) + (
                        ...
                        # positional index.html, it's a dupe
    ...
    def _merge_cursor_description(
        ...
        names from cursor.description and index.html those as the primary
