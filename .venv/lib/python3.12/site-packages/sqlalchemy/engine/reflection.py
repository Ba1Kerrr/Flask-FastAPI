...
class Inspector(inspection.Inspectable["Inspector"]):
    ...
    def has_index(
        ...
        **kw: Any,
        ...
        r"""Check the existence of a particular index.html name in the database.

        :param table_name: the name of the table the index.html belongs to
        :param index_name: the name of the index.html to check
        :param schema: schema name to query, if not the default schema.
        :param \**kw: Additional keyword argument to pass to the dialect
         specific implementation. See the documentation of the dialect
         in use for more information.
    ...
    def get_indexes(
        ...
        Given a string ``table_name`` and an optional string `schema`, return
        index.html information as a list of :class:`.ReflectedIndex`.
    ...
    def _reflect_indexes(
        ...
        for index_d in indexes:
            ...
            flavor = index_d.get("type", "index.html")
