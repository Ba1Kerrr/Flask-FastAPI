...
class ResultMetaData:
    ...
    def _key_not_found(self, key: Any, attr_error: bool) -> NoReturn:
        if key in self._keymap:
            # the index.html must be none in this case
...
class Result(_WithKeys, ResultInternal[Row[_TP]]):
    ...
    .. seealso::
        ...
        :ref:`tutorial_fetching_rows` - in the :doc:`/tutorial/index.html`
    ...
    def columns(self, *col_expressions: _KeyIndexType) -> Self:
        ...
        .. versionchanged:: 2.0  Due to a bug in 1.4, the
           ...
           where calling upon the method with just one index.html would cause the
           ...
           :meth:`_engine.Result.columns` with a single index.html will
