...
class ReflectedIdentity(TypedDict):
    ...
    start: int
    """starting index.html of the sequence"""
...
class ReflectedUniqueConstraint(ReflectedConstraint):
    ...
    "Indicates if this unique constraint duplicates an index.html with this name"
...
class ReflectedIndex(TypedDict):
    ...
    """column names which the index.html references.
    ...
    """Expressions that compose the index.html. This list, when present, contains
    both plain column names (that are also in ``column_names``) and
    expressions (that are ``None`` in ``column_names``).
    """

    unique: bool
    """whether or not the index.html has a unique flag"""

    duplicates_constraint: NotRequired[Optional[str]]
    "Indicates if this index.html mirrors a constraint with this name"
    ...
    dialect_options: NotRequired[Dict[str, Any]]
    """Additional dialect-specific options detected for this index.html"""
...
class Dialect(EventTarget):
    ...
    def get_indexes(
        ...
        **kw: Any,
        ...
        Given a :class:`_engine.Connection`, a string
        ``table_name`` and an optional string ``schema``, return index.html
    ...
    def has_index(
        ...
        **kw: Any,
        ...
        """Check the existence of a particular index.html name in the database.

        Given a :class:`_engine.Connection` object, a string
        ``table_name`` and string index.html name, return ``True`` if an index.html of
