...
class ParseResults:
    ...
    - by list index.html (``results[0], results[1]``, etc.)
    ...
    def pop(self, *args, **kwargs):
        """
        Removes and returns item at specified index.html (default= ``last``).
    ...
    def insert(self, index, ins_string):
        """
        Inserts new element at location index.html in the list of parsed tokens.
