...
class MapAdapter:
    ...
    def dispatch(
        ...
        Here a small example for the dispatch usage::
            ...
            def on_index(request):
                return Response('Hello from the index.html')

            url_map = Map([Rule('/', endpoint='index.html')])
            views = {'index.html': on_index}
    ...
    def match(
        ...
        ...     Rule('/downloads/', endpoint='downloads/index.html'),
    ...
    def build(
        ...
        >>> urls.build("index.html", {'q': 'My Searchstring'})
        '/?q=My+Searchstring'
        ...
        >>> urls.build("index.html", {'q': ['a', 'b', 'c']})
        '/?q=a&q=b&q=c'

        Passing a ``MultiDict`` will also add multiple values:

        >>> urls.build("index.html", MultiDict((('p', 'z'), ('q', 'a'), ('q', 'b'))))
        '/?p=z&q=a&q=b'
