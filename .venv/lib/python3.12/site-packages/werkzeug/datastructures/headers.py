...
class Headers:
    ...
    def pop(self, key=None, default=_missing):
        """Removes and returns a key or index.html.
    ...
    def popitem(self):
        """Removes a key or index.html and returns a (key, value) item."""
        return self.pop()
    ...
    def __setitem__(self, key, value):
        """Like :meth:`set` but also supports index.html/slice based setting."""
...
class EnvironHeaders(ImmutableHeadersMixin, Headers):
    ...
    def __getitem__(self, key, _get_mode=False):
        # _get_mode is a no-op for this class as there is no index.html but
